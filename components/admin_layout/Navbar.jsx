...
export const Navbar = () => {
    ...
    return (
        <>
            <div className="sticky z-10 top-0 h-16 border-b bg-white dark:bg-gray-800 lg:py-2.5">
                <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
                    <h5 hidden className="text-2xl dark:text-slate-50 text-gray-800 font-bold   lg:block ">Admin</h5>
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button className='mr-2 p-2 hover:bg-gray-100 rounded dark:hover:bg-gray-700' onClick={handleClick}>
                            {theme === "dark" ?
