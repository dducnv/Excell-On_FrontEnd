...
import {
    ChevronUpIcon, ChartPieIcon, PresentationChartLineIcon, CurrencyDollarIcon,
    ShoppingBagIcon, ShoppingCartIcon, UserGroupIcon, UsersIcon, HomeIcon, PhotographIcon, UserCircleIcon, CubeIcon, PlusIcon
...
export const Slidebar = () => {
    return (
        <>
            <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white dark:bg-gray-800 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
